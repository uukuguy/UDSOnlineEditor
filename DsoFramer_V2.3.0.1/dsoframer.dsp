...
# ADD CPP /nologo /G5 /Gz /Zp4 /MT /W3 /GX /O1 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_WINDLL" /FD /c
...
# ADD LINK32 oledlg.lib /nologo /base:"0x22000000" /version:1.0 /subsystem:windows /dll /pdb:none /map /machine:I386 /out:"Release/dsoframer.ocx" /opt:nowin98 /merge:.rdata=.text
...
# ADD CPP /nologo /G6 /Zp4 /MTd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_WINDLL" /YX /FD /c
...
# ADD LINK32 oledlg.lib /nologo /version:1.1 /subsystem:windows /dll /map /debug /machine:I386 /out:"Debug/dsoframer.ocx" /pdbtype:con /FORCE:MULTIPLE
...
SOURCE=.\lib\dsoframer.odl

!IF  "$(CFG)" == "dsoframer - Win32 Release"

# PROP Ignore_Default_Tool 1
# Begin Custom Build
InputPath=.\lib\dsoframer.odl

BuildCmds= \
	mktyplib /win32 /tlb lib\dsoframer.olb /h lib\dsoframerlib.h /w0 $(InputPath)

"lib\dsoframer.olb" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"lib\dsoframerlib.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
# End Custom Build
